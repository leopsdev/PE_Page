          ...
          {isOpen && (
            ...
            >
              ...
              <div className="p-2 flex flex-col gap-1">
                <button onClick={() => openModal(setProjectModalOpen)} className="flex items-center gap-2 w-full px-3 py-2 text-sm text-white/80 hover:text-white hover:bg-white/10 rounded-md transition-colors text-left">
                  <LayoutList size={16} />
                  Projetos
                </button>
                <button onClick={() => openModal(setCollabModalOpen)} className="flex items-center gap-2 w-full px-3 py-2 text-sm text-white/80 hover:text-white hover:bg-white/10 rounded-md transition-colors text-left">
                  <BookUser size={16} />
                  Colaboradores
                </button>
                <button onClick={() => openModal(setPartnerModalOpen)} className="flex items-center gap-2 w-full px-3 py-2 text-sm text-white/80 hover:text-white hover:bg-white/10 rounded-md transition-colors text-left">
                  <Handshake size={16} />
                  Parceiros
                </button>

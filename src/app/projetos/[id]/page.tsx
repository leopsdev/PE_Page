...
// Next.js static paths generation for static exports (optional but good practice)
      ...
      <div className="container mx-auto px-6 md:px-12 max-w-5xl">
        ...
        <div className="flex flex-col md:flex-row gap-12 items-start">
          <div className="flex-1 space-y-6">
            <Link href="https://juazeirodonorte.simec.prefeituramunicipal.digital/login" className="inline-block px-4 py-1.5 rounded-full text-sm font-semibold tracking-wide bg-foreground text-background hover:bg-blue-logo hover:text-white transition-all transform hover:scale-105 active:scale-95 shadow-md">
              Acesse
            </Link>
          ...
          <div className={`w-full md:w-[400px] aspect-square rounded-3xl ${project.theme.light} border border-border/50 flex items-center justify-center p-12 shadow-xl shadow-brand-100/50`}>
        ...
        <div className="mt-32 pt-16 border-t border-border/50">
          ...
          <div className="flex overflow-x-auto gap-6 pb-8 snap-x snap-mandatory scrollbar-hide">
            {projects.filter(p => p.id !== project.id).map((otherProject) => (
              ...
              >
                <div className={`aspect-video w-full ${otherProject.theme.light} flex-shrink-0 flex items-center justify-center p-8`}>
                  <div className="relative w-full h-full">
                    <Image
